...
from ..models.models import InferredCode, InferenceRealCrossReference, Concept, RetrievedConcept, RetrievalRealCrossReference, RetrievalInferenceCrossCheck
...
def cross_check_inference_vs_retrieval(inference_cross_reference: InferenceRealCrossReference, retrieved_cross_reference: RetrievalRealCrossReference) -> RetrievalInferenceCrossCheck:
